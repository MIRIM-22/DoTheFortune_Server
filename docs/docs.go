...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/auth/register": {
            "post": {
                "description": "새로운 사용자를 등록합니다. 이메일, 비밀번호(최소 6자), 이름을 입력받아 계정을 생성하고 JWT 토큰을 발급합니다. 토큰은 쿠키에도 저장됩니다.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/fortune/today": {
            "get": {
                ...
                "description": "사용자의 사주 정보를 기반으로 오늘의 운세를 한 줄로 제공합니다. 사주 정보가 등록되어 있어야 하며, 조회 시 기록이 자동으로 저장됩니다.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/records/ai-image": {
            "post": {
                ...
                "description": "AI로 생성된 미래 배우자 이미지의 URL을 기록으로 저장합니다. 외부 AI 이미지 생성 서비스에서 생성된 이미지 URL을 입력받아 저장합니다.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
...
var SwaggerInfo = &swag.Spec{
	...
	Description:      "생년월일과 출생 시각 데이터를 기반으로 개인별 운세와 성향을 분석하고, 진로를 추천하며, 사용자 간의 사주 비교를 통해 궁합을 분석하는 맞춤형 사주 서비스 API입니다.",
